      ...
      body: SafeArea(
        ...
        children: [
          ...
          Positioned.fill(
            ...
            imageUrl:
                'https://drive.google.com/uc?id=1PVgYXYtzFuU2pJjiNN7Nj-U-_X0uR4G0',
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all<Color>(
                                  stateBiomassP.areDateCarbonP
                                      ? Colors.grey
                                      : const Color.fromARGB(255, 51, 79, 31)),
                            ),
                            onPressed: stateBiomassP.areDateCarbonP
                                ? null
                                : () {
                                    Navigator.push(
                                      context,
                        ...
                        if (stateBiomassP.areDateCarbonP)
                          IconButton(
                              onPressed: () {
                                Navigator.push(
                                    context,
