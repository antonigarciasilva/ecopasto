...
class _ResultStState extends State<ResultSt> with WidgetsBindingObserver {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    String level = getCarbonLevelC(widget.resultHerbaceousBiomassST);
    Color levelColor;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: size.height * 0.03),
                  Text(
                    'La retención de carbono en total es de: ${widget.resultCarbonBiomassST.toStringAsFixed(2)} T/ha',
                    textAlign: TextAlign.center,
                    style: const TextStyle(
