...
class ResultCarbonBiomassC extends StatefulWidget {
...
//Variables de SSA
  ...
  @override
  State<ResultCarbonBiomassC> createState() => _ResultCarbonBiomassCState();
}

class _ResultCarbonBiomassCState extends State<ResultCarbonBiomassC>
  ...
  Widget build(BuildContext context) {
    ...
    String level = getCarbonLevelC(widget.resultCarbonBiomassC);
    Color levelColor;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: size.height * 0.03),
                  Text(
                    'La retención de carbono en total es de: ${widget.resultCarbonBiomassC.toStringAsFixed(2)} T/ha',
                    textAlign: TextAlign.center,
                    style: const TextStyle(
